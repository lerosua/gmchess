...
void Board::load_images()
{
	...
	chessman_images[BLACK_ROOK] = Gdk::Pixbuf::create_from_file(DATA_DIR"black_rook.png");
	...
	chessman_images[RED_ROOK] = Gdk::Pixbuf::create_from_file(DATA_DIR"red_rook.png");
